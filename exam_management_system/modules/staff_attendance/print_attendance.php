    ...
    <div class="container">
        ...
        <header class="sheet-header">
            ...
            <div class="header-row">
                ...
                <p style="text-align: right;">Programme: <?php echo isset($_GET['program']) ? htmlspecialchars($_GET['program']) : 'N/A'; ?></p>
            </div>
            <div class="header-row">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <select name="program" id="program" class="form-control">
                        ...
                        $programQuery = "SELECT DISTINCT program FROM cms_staff_attendance";
                ...
                <div class="col-md-4">
                    ...
                    <select name="semester" id="semester" class="form-control">
                        ...
                        $semesterQuery = "SELECT DISTINCT semester FROM cms_staff_attendance";
        ...
        <table class="attendance-table">
            ...
            <tbody>
                ...
                if (!empty($_GET['program'])) {
                    $programName = $conn->real_escape_string($_GET['program']);
                    $conditions[] = "program = '$programName'";
                }
                ...
                $query = "SELECT register_no, staff_name, phone_no, class_no FROM cms_staff_attendance $whereClause";
