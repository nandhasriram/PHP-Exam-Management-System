...
<head>
    ...
    <style>
        ...
        .attendance-table th {
            background-color:rgba(80, 0, 199, 0.61);
            font-weight: bold;
        }
    ...
    <div class="container">
        ...
        <form method="GET" class="mb-4">
            <div class="row">
                ...
                <div class="col-md-4 mt-4">
                    ...
                    <a href="print_reports.php" class="btn btn-secondary">Reset</a>
                </div>
            </div>
        </form>
        ...
        <table class="attendance-table">
            ...
            <tbody>
                ...
                $query = "SELECT register_no, name, student_semester, cgpa, status FROM cms_reports $whereClause";
