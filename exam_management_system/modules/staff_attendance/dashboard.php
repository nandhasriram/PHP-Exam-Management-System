...
<div class="container mt-5">
    <div class="row mt-5">
        <div class="col-md-4">
            ...
            <p>Add Staff Attendance for staffs.</p>
            <a class="btn btn-info" href="staff_attendance.php">Go to Staff Attendance</a>
        </div>
        ...
        <div class="col-md-4">
            ...
            <a class="btn btn-info" href="staff_attendance_report.php">Go to Report Attendance</a>
        </div>
    </div>
    <div class="row mt-5">
        ...
        <div class="col-md-4">
            ...
            <p>Print staff Attendance form model.</p>
