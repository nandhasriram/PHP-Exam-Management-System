    ...
    <div class="container">
        ...
        <header class="sheet-header">
            ...
            <div class="header-row">
                ...
                <p style="text-align: right;">program_nameme: <?php echo isset($_GET['program_name']) ? htmlspecialchars($_GET['program_name']) : 'N/A'; ?></p>
            </div>
            <div class="header-row">
        ...
        <form method="GET" class="mb-4">
            <div class="row">
                <div class="col-md-4">
                    <label for="program_name">program_name Name:</label>
                    <select name="program_name" id="program_name" class="form-control">
                        <option value="">-- Select program_name --</option>
                        <?php
                        // Fetch unique program_name names
                        $program_nameQuery = "SELECT DISTINCT program_name FROM cms_question_paper_preparation";
                        $program_nameResult = $conn->query($program_nameQuery);
                        while ($program_nameRow = $program_nameResult->fetch_assoc()) {
                            $selected = (isset($_GET['program_name']) && $_GET['program_name'] === $program_nameRow['program_name']) ? 'selected' : '';
                            echo "<option value='{$program_nameRow['program_name']}' $selected>{$program_nameRow['program_name']}</option>";
                        }
                        ?>
                    </select>
                </div>
                <div class="col-md-4">
                    ...
                    <select name="semester" id="semester" class="form-control">
                        ...
                        $semesterQuery = "SELECT DISTINCT semester FROM cms_question_paper_preparation";
                ...
                <div class="col-md-4 mt-4">
                    ...
                    <a href="print_question_preparation.php" class="btn btn-secondary">Reset</a>
                </div>
            </div>
        </form>
        ...
        <table class="attendance-table">
            ...
            <tbody>
                ...
                if (!empty($_GET['program_name'])) {
                    $program_nameName = $conn->real_escape_string($_GET['program_name']);
                    $conditions[] = "program_name = '$program_nameName'";
                }
                ...
                $query = "SELECT register_no, staff_name, phone_no, prepare_subject, preparation_date, status FROM cms_question_paper_preparation $whereClause";
