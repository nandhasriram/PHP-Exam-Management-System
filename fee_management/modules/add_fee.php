...
//$conn = new mysqli("localhost", "jpninfot_user","prakash2312", "jpninfot_fee_management");
$conn = new mysqli("localhost", "root","", "fee_management");

$SQuery = "SELECT MAX(Feereceiptno) as maxrn FROM main_feereceipt ";
$result = $conn->query($SQuery);
 if ($result->num_rows > 0) {
   while($row = $result->fetch_assoc()) {    
    //echo "t1";
   $feereceiptcount=$row['maxrn']; 
   }
}
 $feereceiptcount++; 
//$conn -> close();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        foreach ($particulars as $index => $particular) {
            ...
            $stmt2->execute([$sno, $feereceipt_id, $studentRollNumber, $addmissionno, $studentName, $class, $section, $year, $particular, $amount, $amountpaid, $dueamount, $term, $duedate, $description]);
            echo "t2";
        }
...
<body><?php echo $feereceiptcount; ?>
  ...
  <td   ><input name="search" value="search" type="submit" /></td> </tr></table>
        ...
        <form action="add_fee_editsave.php" method="post">
            <div class="form-row">
            <div class="form-group">
                    <label for="feereceiptno">Fee Receipt No</label>
                    <input type="text" id="feereceiptno" value="<?php echo $feereceiptcount; ?>" name="feereceiptno" required>
                </div>
                <div class="form-group">
          ...
          <!--  <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="duedate" value="<?php echo $duedate; ?>" name="duedate">
                </div>
            ...
            <div class="button-group">
                <button type="submit" name="savereceipt" value="savereceipt" class="button">Submit</button>
